...
instance EmbPrj Definition where
  icod_ (Defn a b c d e f g h i j k l m n o blocked r up s) =
    icodeN' Defn a b (P.killRange c) d e f g h i j k l m n o (ossify blocked) r up s
    where
